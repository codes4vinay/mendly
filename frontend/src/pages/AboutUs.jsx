        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-3xl">
            ...
            <p className="text-muted-foreground text-lg mt-6">
              RPAR connects customers with service centres and gives both sides
              the tools to manage bookings, products, updates, and conversations
              without the usual back-and-forth confusion.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid gap-8 lg:grid-cols-2 items-start">
          ...
          <div className="rounded-3xl border border-foreground/10 bg-card p-8">
            ...
            <p className="text-sm text-muted-foreground mt-3 leading-7">
              ...
              RPAR helps customers take action quickly and helps service centres
              run a more organized digital workflow.
            </p>
          </div>
        </div>
      </section>
