...
const values = [
  ...
  },
  {
    ...
    description:
      "From pricing to status tracking, Mendly is built to reduce guesswork and help repairs feel manageable.",
  },
];
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-3xl">
            ...
            <p className="text-muted-foreground text-lg mt-6">
              Mendly connects customers with service centres and gives both
        ...
        <div className="grid gap-8 lg:grid-cols-2 items-start">
          <div>
            ...
            <p className="text-muted-foreground mt-4 leading-7">
              ...
              calls, unclear timelines, and limited visibility, Mendly brings
          ...
          <div className="rounded-3xl border border-foreground/10 bg-card p-8">
            ...
            <p className="text-sm text-muted-foreground mt-3 leading-7">
              ...
              Mendly helps customers take action quickly and helps service
